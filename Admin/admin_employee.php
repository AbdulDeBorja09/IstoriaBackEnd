            ...
            <tbody>
              <?php 
                ...
                <tr>
                    ...
                    <td><b><?php echo $fetch_employee['employee_id'] ?></b></td>
                    <td><?php echo $fetch_employee['name'] ?></td>
                    <td><?php echo $fetch_employee['rank'] ?></td>
                    <td><?php echo $fetch_employee['hire_date'] ?></td>
                    <td><form method="post" class="products-edit">
                    <a class="bin-button" name="delete" href="admin_employee.php?delete=<?php echo $fetch_employee['eid']; ?>" class="btn delete" onclick="return confirm('Delete this product?')">
                      <svg
                    ...
                    <a href="admin_employee_edit.php?edit=<?php echo $fetch_employee['eid']; ?>" class="edit-button" name="edit">
