...
<html lang="en">
  ...
  <body>
            ...
            <?php 
              ...
              <tr>
                ...
                <td align="center"><form method="post">
                  <a id="editmodalBtn" class="edit-button" name="edit">
    ...
    <div id="editdModal" class="editmodal">
      <div class="modal-content">
        ...
        <form method="post">
            <div class="content">
                  ...
                  <button name="edit">SUBMIT EDIT</button>
            </div>
          </form>
      </div>
    </div>
    <script>
      ...
      var modal = document.getElementById("editdModal");
      var btn = document.querySelectorAll(".editmodalBtn");
