...
<body>
    <?php include 'navbar.php' ?> <div style="padding: 90px">
    </div>
    <div class="container">
        ...
        <div class="subnav-coffee">
            <div class="left">
                ...
                <?php
                  $select_prodcut = mysqli_query($conn, "SELECT * FROM `products` WHERE category ='noncoffee'") or die ('queryfailed');
        ...
        <?php 
          $select_prodcuts = mysqli_query($conn, "SELECT * FROM `products` WHERE category ='noncoffee'") or die ('query failed');
          if(mysqli_num_rows($select_prodcuts)>0){
        ?>
        <div class="coffe-flex">
            <?php 
           $select_prodcuts = mysqli_query($conn, "SELECT * FROM `products` WHERE category ='noncoffee' AND status = 'available'  $sort_order") or die ('query failed');
          if(mysqli_num_rows($select_prodcuts)>0){
          ...
          ?>
            ...
            ?>
             <?php 
          $select_prodcuts = mysqli_query($conn, "SELECT * FROM `products` WHERE category ='noncoffee' AND status = 'unavailable' ") or die ('query failed');
          if(mysqli_num_rows($select_prodcuts)>0){
              while($fetch_products = mysqli_fetch_assoc($select_prodcuts)){
          ?>
          <div class="box">
