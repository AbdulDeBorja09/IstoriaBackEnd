                            ...
                            <div class="modal-div-2 col-lg-6">
                                ...
                                <table class="addonts-table w-50" style="background-color: #f6f3f1">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="checkbox" class="btn-check" id="espresso"
                                                    autocomplete="off" />
                                        ...
                                        <tr>
                                            <td>
                                                <input type="checkbox" class="btn-check" id="sauce"
                                                    autocomplete="off" />
                                        ...
                                        <tr>
                                            <td>
                                                <input type="checkbox" class="btn-check" id="syrup"
                                                    autocomplete="off" />
                                        ...
                                        <tr>
                                            <td>
                                                <input type="checkbox" class="btn-check" id="drizzle"
                                                    autocomplete="off" />
                                ...
                                <hr />
                                <a href="user_viewpage.php" class="viewdetails"><span
                                        class="hover-underline-animation">VIEW
                                        FULL DETAILS</span>
